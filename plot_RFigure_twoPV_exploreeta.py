...
if __name__ == "__main__":
	...
	plt.savefig('./TwoPVPSfixedsametauNMDARetaPV%sratesandweights_all2dt%s.png'%(str(sim.eta_P),name), bbox_inches='tight')
	plt.savefig('./TwoPVPSfixedsametauNMDARetaPV%sratesandweights_all2dt%s.pdf'%(str(sim.eta_P),name), bbox_inches='tight')
...
#		pass
	...
	a2.spines['right'].set_visible(False)
	plt.tight_layout()
	plt.savefig('./TwoPVPSfixedsametauNMDAetaPV%sPVratesandweights_all2dt%s.png'%(str(sim.eta_P),name), bbox_inches='tight')
	plt.savefig('./TwoPVPSfixedsametauNMDAetaPV%sPVratesandweights_all2dt%s.pdf'%(str(sim.eta_P),name), bbox_inches='tight')
