...
if __name__ == "__main__":
	...
	circuit1.wPS_P = np.array([wP+(perturbation*wP)])
	...
	circuit2.wPS_P = np.array([wP+(perturbation*wP)])
	sim = Sim(stimulus_duration=1)
	...
	circuit.wPS_P = np.array([wP+(perturbation*wP)])
	sim = Sim(stimulus_duration=1)
	...
	plt.savefig('./perturb-10percent_PVratesandweights_all2%s.png'%name, bbox_inches='tight')
	plt.savefig('./perturb-10percent_PVratesandweights_all2%s.pdf'%name, bbox_inches='tight')
